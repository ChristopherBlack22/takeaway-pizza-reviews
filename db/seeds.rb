...
Review.create(content: "Best pizza of my lifetime", user_id: "1", takeaway_pizza_id: "1")
...
Review.create(content: "Superb", user_id: "4", takeaway_pizza_id: "2")
Review.create(content: "Cowabunga", user_id: "4", takeaway_pizza_id: "3")